...
//
// On Thu Apr  6 04:41:59 IST 2017
//
//
// Ports:
// Name                         I/O  size props
...
module mkTestbench(CLK,
  ...
  wire pc$EN_uart_ifc_sin, pc$uart_ifc_sin_in, pc$uart_ifc_sout;
  ...
  wire [3 : 0] x__h3131, x__h4772, x__h6587, x__h6613;
  ...
  mkSoC pc(.CLK(CLK),
	   .RST_N(RST_N),
	   .uart_ifc_sin_in(pc$uart_ifc_sin_in),
	   .EN_uart_ifc_sin(pc$EN_uart_ifc_sin),
	   .RDY_uart_ifc_sin(),
	   .uart_ifc_sout(pc$uart_ifc_sout),
	   .RDY_uart_ifc_sout(),
	   .uart_ifc_busy(),
	   .RDY_uart_ifc_busy());
  ...
  assign uart_rXmitCellCount$D_IN =
	     uart_pwXmitCellCountReset$whas ? 4'd0 : x__h6587 ;
  ...
  // register uart_rXmitParity
  assign uart_rXmitParity$D_IN = z__h8036 ^ uart_fifoXmit$D_OUT[7] ;
  ...
  // submodule pc
  assign pc$uart_ifc_sin_in = uart_rXmitDataOut ;
  assign pc$EN_uart_ifc_sin = 1'd1 ;
  ...
  assign x__h3131 = uart_rRecvCellCount + 4'd1 ;
  assign x__h4772 = uart_rRecvBitCount + 4'd1 ;
  assign x__h6587 = uart_rXmitCellCount + 4'd1 ;
  assign x__h6613 = uart_rXmitBitCount + 4'd1 ;
  assign z__h8001 = uart_fifoXmit$D_OUT[0] ^ uart_fifoXmit$D_OUT[1] ;
  assign z__h8008 = z__h8001 ^ uart_fifoXmit$D_OUT[2] ;
  assign z__h8015 = z__h8008 ^ uart_fifoXmit$D_OUT[3] ;
  assign z__h8022 = z__h8015 ^ uart_fifoXmit$D_OUT[4] ;
  assign z__h8029 = z__h8022 ^ uart_fifoXmit$D_OUT[5] ;
  assign z__h8036 = z__h8029 ^ uart_fifoXmit$D_OUT[6] ;
