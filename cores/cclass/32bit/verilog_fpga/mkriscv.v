...
//
// On Tue Mar 28 10:39:43 IST 2017
//
//
// Ports:
// Name                         I/O  size props
...
module mkriscv(CLK,
  ...
  wire [31 : 0] bpu$_flush_new_pc_;
  wire bpu$EN__flush, bpu$EN_deq_fifo, bpu$EN_send_output_, bpu$pred_type;
  ...
  reg [133 : 0] CASE_fn_decoder_5_BITS_36_TO_32_0b11000_0_CONC_ETC__q1,
		CASE_fn_decoder_5_BITS_61_TO_60_1_0_CONCAT_DON_ETC__q2;
  reg [63 : 0] v__h2132,
	       v__h2428,
	       v__h2523,
	       v__h2571,
  ...
  wire [134 : 0] fn_branch___d96;
  wire [61 : 0] fn_decoder___d65;
  wire [31 : 0] aluresult__h3072, x_program_counter__h2954;
  wire [24 : 0] x__h3076;
  wire [4 : 0] x_opcode__h2790;
  wire [2 : 0] x_funct3__h2791;
  wire NOT_fn_decoder_5_BITS_61_TO_60_6_EQ_2_9_33_AND_ETC___d145,
       register_file__inputs_from_decode_stage_0_BIT__ETC___d151,
       register_file__inputs_from_decode_stage_0_BIT__ETC___d158;
  ...
  assign CAN_FIRE_RL_rl_send_pc_fetch_request =
	     icache$RDY_request_from_cpu && !wr_flush_decode_cache &&
	     !wr_flush_all &&
	     ff_if_id$FULL_N ;
  ...
  assign wr_flush_decode_cache_1$whas =
	     WILL_FIRE_RL_rl_decode_and_operand_fetch &&
	     fn_decoder___d65[61:60] != 2'd3 &&
	     fn_decoder___d65[61:60] != 2'd1 &&
	     fn_decoder___d65[61:60] != 2'd2 &&
	     register_file__inputs_from_decode_stage_0_BIT__ETC___d158 ;
  ...
  assign wr_effective_address$D_IN =
	     wr_flush_decode_cache_1$whas ? fn_branch___d96[36:5] : 32'd0 ;
  ...
  module_fn_decoder instance_fn_decoder_0(.fn_decoder__instruction(ff_if_id$D_OUT[37:6]),
					  ...
					  .fn_decoder(fn_decoder___d65));
  module_fn_branch instance_fn_branch_1(.fn_branch__opcode(x_opcode__h2790),
					.fn_branch__funct3(x_funct3__h2791),
					.fn_branch__current_pc(x_program_counter__h2954),
					.fn_branch__immediate_value(fn_decoder___d65[21:2]),
					...
					.fn_branch(fn_branch___d96));
  assign NOT_fn_decoder_5_BITS_61_TO_60_6_EQ_2_9_33_AND_ETC___d145 =
	     fn_decoder___d65[61:60] != 2'd2 &&
	     register_file$_inputs_from_decode_stage[96] &&
	     (fn_decoder___d65[36:32] == 5'b11000 ||
	      fn_decoder___d65[36:32] == 5'b11011 ||
	      fn_decoder___d65[36:32] == 5'b11001) ;
  assign aluresult__h3072 = { 7'd0, x__h3076 } ;
  assign register_file__inputs_from_decode_stage_0_BIT__ETC___d151 =
	     register_file$_inputs_from_decode_stage[96] &&
	     (fn_decoder___d65[36:32] == 5'b11000 ||
	      fn_decoder___d65[36:32] == 5'b11011 ||
	      fn_decoder___d65[36:32] == 5'b11001) &&
	     fn_branch___d96[37] ;
  assign register_file__inputs_from_decode_stage_0_BIT__ETC___d158 =
	     register_file$_inputs_from_decode_stage[96] &&
	     (fn_decoder___d65[36:32] == 5'b11000 ||
	      fn_decoder___d65[36:32] == 5'b11011 ||
	      fn_decoder___d65[36:32] == 5'b11001) &&
	     !fn_branch___d96[37] ;
  assign x__h3076 =
	     { fn_decoder___d65[36:29],
	       fn_decoder___d65[13:2],
	       fn_decoder___d65[59:55] } ;
  assign x_funct3__h2791 = fn_decoder___d65[31:29] ;
  assign x_opcode__h2790 = fn_decoder___d65[36:32] ;
  assign x_program_counter__h2954 = ff_if_id$D_OUT[69:38] ;
  always@(fn_decoder___d65 or
	  register_file$_inputs_from_decode_stage or fn_branch___d96)
  begin
    case (fn_decoder___d65[36:32])
      5'b11000, 5'b11001, 5'b11011:
	  CASE_fn_decoder_5_BITS_36_TO_32_0b11000_0_CONC_ETC__q1 =
	      { 2'd0,
		95'h2AAAAAAAAAAAAAAAAAAAAAAA /* unspecified value */ ,
		fn_branch___d96[134:103],
		5'd0 };
      default: CASE_fn_decoder_5_BITS_36_TO_32_0b11000_0_CONC_ETC__q1 =
		   { 2'd2,
		     register_file$_inputs_from_decode_stage[95:0],
		     fn_decoder___d65[36:1] };
    endcase
  end
  always@(fn_decoder___d65 or
	  CASE_fn_decoder_5_BITS_36_TO_32_0b11000_0_CONC_ETC__q1 or
	  aluresult__h3072)
  begin
    case (fn_decoder___d65[61:60])
      2'd1:
	  CASE_fn_decoder_5_BITS_61_TO_60_1_0_CONCAT_DON_ETC__q2 =
	      { 2'd0,
		95'h2AAAAAAAAAAAAAAAAAAAAAAA /* unspecified value */ ,
	  ...
	  CASE_fn_decoder_5_BITS_61_TO_60_1_0_CONCAT_DON_ETC__q2 =
		...
		aluresult__h3072,
		5'd0 };
      default: CASE_fn_decoder_5_BITS_61_TO_60_1_0_CONCAT_DON_ETC__q2 =
		   CASE_fn_decoder_5_BITS_36_TO_32_0b11000_0_CONC_ETC__q1;
    endcase
  end
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_execute && ff_id_ie$D_OUT[176:175] != 2'd0 &&
	  ff_id_ie$D_OUT[176:175] != 2'd1)
	$display(v__h4894, "\tExecution: ALU Operation");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_execute && ff_id_ie$D_OUT[176:175] != 2'd0 &&
	  ff_id_ie$D_OUT[176:175] != 2'd1)
	begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_execute && ff_id_ie$D_OUT[176:175] == 2'd0)
	$display(v__h5822, "\tExecution: BRANCH Instruction");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_execute && ff_id_ie$D_OUT[176:175] == 2'd1)
	$display(v__h6096, "\tExecution: SYSTEM Instruction");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_decode_and_operand_fetch &&
	  fn_decoder___d65[61:60] == 2'd1)
	$display(v__h2898, "\tDC_STAGE: ILLEGAL INSTRUCTION");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_decode_and_operand_fetch &&
	  fn_decoder___d65[61:60] != 2'd3 &&
	  fn_decoder___d65[61:60] != 2'd1 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  fn_decoder___d65[61:60] != 2'd2 &&
	  register_file$_inputs_from_decode_stage[96])
	$display(v__h3463, "\tGOT VALID OPERANDS");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_decode_and_operand_fetch &&
	  fn_decoder___d65[61:60] != 2'd3 &&
	  fn_decoder___d65[61:60] != 2'd1 &&
	  NOT_fn_decoder_5_BITS_61_TO_60_6_EQ_2_9_33_AND_ETC___d145)
	begin
	  v__h3549 = $time;
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  fn_decoder___d65[61:60] != 2'd1 &&
	  NOT_fn_decoder_5_BITS_61_TO_60_6_EQ_2_9_33_AND_ETC___d145)
	$display(v__h3549, "\t Sending inputs to branch unit");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_decode_and_operand_fetch &&
	  fn_decoder___d65[61:60] != 2'd3 &&
	  fn_decoder___d65[61:60] != 2'd1 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  fn_decoder___d65[61:60] != 2'd2 &&
	  !register_file$_inputs_from_decode_stage[96])
	$display(v__h4321, "\tWaiting for valid operands");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_decode_and_operand_fetch)
	begin
	  v__h4443 = $time;
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_decode_and_operand_fetch)
	$display(v__h4443, "\t********** DECODE STAGE FIRING ************");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_decode_and_operand_fetch)
	begin
	  v__h4483 = $time;
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_decode_and_operand_fetch && fn_decoder___d65[39])
	$write("FloatingRF");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_decode_and_operand_fetch && !fn_decoder___d65[39])
	$write("IntegerRF");
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_decode_and_operand_fetch)
	$write(v__h4546, "\tRs1: %d", fn_decoder___d65[59:55], " ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_decode_and_operand_fetch && fn_decoder___d65[38])
	$write("FloatingRF");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_decode_and_operand_fetch && !fn_decoder___d65[38])
	$write("IntegerRF");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_decode_and_operand_fetch)
	$write(" Rs2: %d", fn_decoder___d65[54:50], " ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_decode_and_operand_fetch && fn_decoder___d65[37])
	$write("FloatingRF");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_decode_and_operand_fetch && !fn_decoder___d65[37])
	$write("IntegerRF");
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_flush_first_two_stages)
	$display(v__h2132, "\tFlushing the fetch stage alone");
    if (RST_N != `BSV_RESET_VALUE)
