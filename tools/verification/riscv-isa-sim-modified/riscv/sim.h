...
public:
  ...
  void set_risc_dump_flag(bool dmp_flg,int typ, int memDmpFlg, int64_t mem_strt, int64_t mem_ed); // nandu
...
private:
  ...
  void interactive();
  void risc_dump();//nandu
  void interactive_regs_dump(const std::string& cmd, const std::vector<std::string>& args); //nandu
  void interactive_fregs_dump(const std::string& cmd, const std::vector<std::string>& args); //nandu
...
extern volatile bool risc_dump_flag; // nandu
